...
public:
    ...
    size_t prefix_filtering(const LongestPrefixMatcher<uint16_t>& lpm, const std::vector<uint8_t>& prefix, const std::vector<size_t>& candidates, size_t* buffer) const;
    size_t prefix_filtering_lazy(const LongestPrefixMatcher<uint16_t>& lpm, const std::vector<uint8_t>& prefix, const std::vector<size_t>& candidates, size_t* buffer) const;
    ...
    size_t prefix_filtering_decompress(const std::vector<uint8_t>& prefix, const std::vector<size_t>& candidates, size_t* buffer) const;
    ...
    std::vector<TokenStats> get_token_statistics() const;
};
